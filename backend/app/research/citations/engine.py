...
from app.research.models import Citation, ResearchSource
...
class CitationEngine:
    ...
    def get_citation(self, url: str) -> Citation | None:
    ...
    def validate_citations(
        ...
        for citation_text in citations_in_text:
            if any(url in citation_text for url in source_urls) or any(
                domain in citation_text for domain in source_domains
            ):
