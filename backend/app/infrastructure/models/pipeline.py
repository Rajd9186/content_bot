...
class PipelineRun(Base):
    ...
    research_data: Mapped[dict | None] = mapped_column(JSONBColumn, nullable=True)
    plan: Mapped[dict | None] = mapped_column(JSONBColumn, nullable=True)
    outline: Mapped[dict | None] = mapped_column(JSONBColumn, nullable=True)
    ...
    node_results: Mapped[dict | None] = mapped_column(JSONBColumn, nullable=True, default=dict)
    errors: Mapped[dict | None] = mapped_column(JSONBColumn, nullable=True, default=dict)
