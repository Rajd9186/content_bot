...
- Name: responsive.spec.ts >> Responsive Design >> Mobile - projects section loads
- Location: tests\e2e\responsive.spec.ts:57:9
...
Call log:
  - waiting for locator('nav').getByText(/projects/i)
    - locator resolved to <span class="whitespace-nowrap font-medium">Projects</span>
